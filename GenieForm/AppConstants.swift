...
struct AppConstants {
    ...
    static let primaryWhiteColor = UIColor(red: 74.0/255.0, green: 74.0/255.0, blue: 74.0/255.0, alpha: 1.0)
    ...
    static let secondaryRedColor : UIColor = UIColor(red: 192.0/255.0, green: 57.0/255.0, blue: 43.0/255.0, alpha: 1.0)
    
    static let invisibleLightColor : UIColor = UIColor(white: 1, alpha: 0.01)
    
    static let textFieldBorderColor : UIColor = AppConstants.secondaryBlackColor.withAlphaComponent(0.3)
    static let validationErrorColor : UIColor = AppConstants.secondaryRedColor.withAlphaComponent(0.25)
}
